...
#saveDataBtn, #deleteDataBtn, #searchBtn{margin-right:5px;}
#bankBookDetailTable{table-layout:fixed;}
</style>
		...
		if (result.status) {
			...
			for (var i = 0; i < listLength; i++) {
				...
				var html  = '<tr idx="' + thisData.bankBookDetailIdx + '" bankBookIdx="' + thisData.bankBookIdx + '">';
					...
					html += '	<td class="text-tooltip text-center amount_type" amountType="' + thisData.amountType + '">' + (amountType == 'IN' ? '입금' : '출금') + '</td>';
					html += '	<td class="text-tooltip">' + ( thisData.category1 ? thisData.category1.categoryName : '' )+ '</td>';
					html += '	<td class="text-tooltip">' + ( thisData.category2 ? thisData.category2.categoryName : '' ) + '</td>';
					html += '	<td class="text-tooltip">' + ( thisData.category3 ? thisData.category3.categoryName : '' ) + '</td>';
					html += '	<td class="text-tooltip text-right ' + colorType + '">' + common.number.addComma(thisData.amount) + '</td>';
					html += '	<td class="text-tooltip text-center">' + common.date.toString(new Date(thisData.amountDate), '-') + '</td>';
					html += '	<td class="text-tooltip">' + (thisData.content ? thisData.content : '') + '</td>';
					html += '	<td class="text-tooltip text-center">';
...
<div class="container-fluid">
	...
	<div class="col-lg-12">
		<h4 class="mb-2 text-gray-800 float-left">통장 상세 내역</h4>
           		...
           		<table class="table">
					...
					<tbody>
						<tr>
							...
							<td>
								<select class="form-control form-control-sm search_amount_type_select">
							...
							<td>
								<input type="text" class="form-control form-control-sm search_amount_input text-right float-left" id="searchStartAmount" value="0" maxLength="15"/>
								<span class="hyphen-span">-</span>
								<input type="text" class="form-control form-control-sm search_amount_input text-right float-right" id="searchEndAmount" value="0" maxLength="15"/>
							</td>
							<th class="text-right">일자</th>
							<td>
								<input type="text" class="form-control form-control-sm search_amount_date_input datepicker float-left" id="searchStartDate"/>
								<span class="hyphen-span">-</span>
								<input type="text" class="form-control form-control-sm search_amount_date_input datepicker float-right" id="searchEndDate"/>
							</td>
							<td></td>
						</tr>
						<tr>
							...
							<td colspan="3">
								...
								<select class="form-control form-control-sm category2_select float-left" id="searchCategory2">
									<option value="">선택없음</option>
								</select>
								<select class="form-control form-control-sm category3_select float-left" id="searchCategory3">
									<option value="">선택없음</option>
								</select>
							</td>
...
<div class="container-fluid">
	...
	<div class="button-div">
		...
		<button type="button" id="searchBtn"		class="btn btn-primary btn-sm float-right">검색</button>
	</div>
</div>

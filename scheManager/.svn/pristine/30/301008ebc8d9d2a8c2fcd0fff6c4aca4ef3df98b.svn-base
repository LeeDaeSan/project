...
<div class="col-lg-6 join-div">
	<form action="/join/insert" method="POST" id="form">
		<input type ="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
		<table class="table">
			<tr>
				<th><label for="email">이메일</label></th>
				<td><input type="text" class="form-control" name="id" id="email" size="50" placeholder="Enter email">ex)wjdxo513@naver.com</td>	
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" class="form-control" name="birth" id="birth" size="6" placeholder="생년월일">※19921005</td>
			</tr>
			<tr>
	...
	<button class="btn btn-info center-block" type="button" id="create">회원가입</button>	
</div>

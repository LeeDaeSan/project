	...
	var board = new Vue({
		...
		methods : {
			...
			list : function (){
				...
				this.limit = $('#searchLimit').val();
				
				var params = new URLSearchParams();
				params.append('page', 				startCount);
				params.append('limit', 				this.limit);
				params.append('sort',				$("#sort").val());
				params.append('searchKeyword', 		$("#searchBoardName").val());
				params.append('searchSelectType', 	$("#searchBoardType").val());
				...
				axios.post("/boardManager/list", params).then(response => {
					...
					if ( response.status == 200 ){
						...
						if (dataList.length > 0) {
							...
							paging.emptyList("#boardWrap table tbody", 6);
...
<div>
	<div class="mgnb10 mgnt20">
		...
		<select class="form-control display_ib width100 fr mgnb10" id="searchLimit">
